...
print (f'Cartoes pré-cadastrados: {len(todos_os_cartoes)}')
...
try:
	use_cases.cadastra_compra(1, 0, 'Alimentação', 'Pizza Dois Ped~ços')
...
try:
	use_cases.cadastra_cartao(1, 50_000.0,'Alimentação', 'Pizza Dois Pedaços')

except Exception as e:
	print (e)


class ValorExcedidoException(Exception):
